...
namespace BanHangOnline.Models
{
    public partial class BanHangOnlineContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-FA2PTVE\\SQLEXPRESS; Database=BanHangOnline; Integrated Security=true;");
            }
        }
        ...
        public DbSet<BanHangOnline.ModelViews.RegisterViewModel> RegisterViewModel { get; set; }

        public DbSet<BanHangOnline.ModelViews.LoginViewModel> LoginViewModel { get; set; }

        public DbSet<BanHangOnline.Areas.Admin.AdminModelViews.AdminRegisterViewModel> AdminRegisterViewModel { get; set; }
    }
}
