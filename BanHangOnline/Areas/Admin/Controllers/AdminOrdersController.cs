...
namespace BanHangOnline.Areas.Admin.Controllers
{
    ...
    public class AdminOrdersController : Controller
    {
        ...
        public AdminOrdersController(BanHangOnlineContext context)
        {
            _context = context;
        }
        [Route("don-hang.html", Name = ("Orders"))]
        public IActionResult Index(int? page)
        {
            // phân trang
            var pageNumber = page == null || page <= 0 ? 1 : page.Value;
            var pageSize = 20; // kích thươc trang
            var lsOrder = _context.Orders
                .AsNoTracking()
                .Include(o => o.Customer).Include(o => o.TransactStatus)
                .OrderBy(x => x.OrderId);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            try
            {
                ...
                var chitietdonhang = _context.OrderDetails
                    ...
                    .ToList();
                AdminXemDonHangController donHang = new AdminXemDonHangController();
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,TotalMoney,Note,Address")] Order order)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customers, "CustomerId", "CustomerId", order.CustomerId);
            ViewData["FullName"] = new SelectList(_context.Customers, "CustomerId", "FullName", order.CustomerId);
