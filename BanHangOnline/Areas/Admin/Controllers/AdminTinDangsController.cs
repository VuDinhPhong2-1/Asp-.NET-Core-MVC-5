...
namespace BanHangOnline.Areas.Admin.Controllers
{
    ...
    public class AdminTinDangsController : Controller
    {
        ...
        public AdminTinDangsController(BanHangOnlineContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int? page)
        {
            ...
            var lsTinDang = _context.TinDangs
                .AsNoTracking()
                .OrderBy(x => x.PostId);
            PagedList<TinDang> models = new PagedList<TinDang>(lsTinDang, pageNumber, pageSize);
