...
namespace BanHangOnline.Areas.Admin.Controllers
{
    ...
    public class AdminProductsController : Controller
    {
        ...
        public AdminProductsController(BanHangOnlineContext context, INotyfService notyfService)
        {
            _context = context;
        ...
        public IActionResult Index(int page = 1, int CatID = 0)
        {
            ...
            ViewBag.CurrentCateID = CatID;// dùng để phân trang

            ViewBag.CurrentPage = pageNumber;// dùng để đếm trang



            // lọc dữ liệu trong ds dữ liệu
